...
validateUsername = function (username) {
  if (username.length >= 3) {
    ...
    loginButtonsSession.errorMessage("ERROR_length_username");
    return false;
  }
};
validateEmail = function (email) {
  ...
  if (email.indexOf('@') !== -1) {
    ...
    loginButtonsSession.errorMessage("ERROR_invalid_email");
    return false;
  }
};
validatePassword = function (password) {
  if (password.length >= 6) {
    ...
    loginButtonsSession.errorMessage("ERROR_length_password");
    return false;
  }
};
